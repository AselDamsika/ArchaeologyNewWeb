...
<head>
	...
	<div class="slider">
		<div id="wowslider-container1">
			<div class="ws_images">
				<ul>
                	<li><img src="assets/data1/images/07-08-2024.jpg" alt="Department of Archaeology" title="Department of Archaeology" id="wows1_0"/></li>
					<li><img src="assets/data1/images/001.jpg" alt="Department of Archaeology" title="Department of Archaeology" id="wows1_0"/></li>
					<li><img src="assets/data1/images/005new.jpg" alt="" title="" id="wows1_1"/></li>
					<li><img src="assets/data1/images/008new.jpg" alt="" title="" id="wows1_2"/></li>
					<li><img src="assets/data1/images/002new.jpg" alt="slider" title="" id="wows1_3"/></li>
					<li><img src="assets/data1/images/006new.jpg" alt="" title="" id="wows1_4"/></li>
				</ul>
			</div>
			<div class="ws_bullets">
				<div>
					<a href="#" title="Department of Archaeology"><span><img src="assets/data1/tooltips/001new2.jpg" alt="Department of Archaeology"/>1</span></a>
					<a href="#" title=""><span><img src="assets/data1/tooltips/005new.jpg" alt=""/>2</span></a>
					<a href="#" title=""><span><img src="assets/data1/tooltips/007new.jpg" alt=""/>3</span></a>
					<a href="#" title=""><span><img src="assets/data1/tooltips/002new.jpg" alt=""/>4</span></a>
					<a href="#" title=""><span><img src="assets/data1/tooltips/006new.jpg" alt=""/>5</span></a>
				</div>
			</div>
...
The teaching of archaeology at Peradeniya, was originally introduced as an auxiliary subject to history, as a sub-department, for the purpose of training future archaeological officers required by the state. In 1957, Dr. Senarat Paranavitana on his retirement from the post of Commissioner of Archaeology was appointed as the Professor of Archaeology, which marked the official beginning of the Department of Archaeology, University of Peradeniya. The notable archaeologists, namely, Prof Senarat Paranavitana, Prof. P.L. Prematilleke and Prof. Sudharshan Seneviratne have served in the Department.
                ...
                <div class="col-md-4 noticeBoard">
                    ...
                    <h4><i class="fa fa-tags"></i>Old Money and Ancient Writing:  Archaeology undergraduates visit the National Museum and (state) Department of Archaeology to study coins and inscriptions</h4> <h5><a href="videos/Study tour.pdf" target="_blank">More Info </a></h5>
